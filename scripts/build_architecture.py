...
def build(simple=False):
    ...
    if simple:
        ...
        arrow("ask", 292, 230, 308, 230)
        arrow("execute", 652, 230, 668, 230)
        arrow("respond", 1092, 230, 1108, 230)
        text("connector-note", 40, 350, "The Power BI tool is a connector action inside the topics, not a tool per question. No Fabric data agent or MCP required.", 17, 1360)
